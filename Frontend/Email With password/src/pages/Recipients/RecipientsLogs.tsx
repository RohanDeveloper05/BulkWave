                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <span
                                        className={clsx(
                                            "status-badge",
                                            statusColors[row.status] || "status-pending"
                                        )}
                                    >
                                        {row.status}
                                    </span>
                                ...
                                <td className="px-6 py-4 text-center">
                                    <div className="flex flex-wrap justify-center gap-2">
                                        <span className="about-tag about-tag-type">
                                            {row.recipient_type}
                                        </span>

                                        {row.list_name && (
                                            <span className="about-tag about-tag-list">
                                                {row.list_name}
                                            </span>
                                        )}

                                        {row.uploaded_file && (
                                            <span className="about-tag about-tag-file">
                                                File
                                            </span>
                                        )}
                                    </div>
